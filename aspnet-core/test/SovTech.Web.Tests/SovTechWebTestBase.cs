...
using SovTech.Models.TokenAuth;
...
{
    public abstract class SovTechWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SovTechWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SovTechWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SovTechDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SovTechDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SovTechDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SovTechDbContext, Task<T>> func)
        {
            T result;
