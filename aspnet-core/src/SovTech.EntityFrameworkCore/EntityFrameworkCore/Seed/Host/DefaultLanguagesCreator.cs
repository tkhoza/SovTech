...
namespace SovTech.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly SovTechDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = SovTechConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(SovTechDbContext context)
        {
            _context = context;
        }
