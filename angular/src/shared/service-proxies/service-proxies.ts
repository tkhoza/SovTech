...
export class CategoriesServiceProxy {
     ...
     * @return Success
     */
    getAllCategories(): Observable<StringListResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Categories/GetAllCategories";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<StringListResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<StringListResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAllCategories(response: HttpResponseBase): Observable<StringListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<StringListResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    getAllCategoriesDetails(filterText: string | undefined): Observable<string> {
        let url_ = this.baseUrl + "/api/services/app/Categories/GetAllCategoriesDetails?";
        if (filterText === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllCategoriesDetails(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllCategoriesDetails(<any>response_);
                } catch (e) {
    ...
    protected processGetAllCategoriesDetails(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getPeople(filterText: string | undefined): Observable<PeopleDtoListResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Categories/GetPeople?";
        if (filterText === null)
            throw new Error("The parameter 'filterText' cannot be null.");
        else if (filterText !== undefined)
            url_ += "filterText=" + encodeURIComponent("" + filterText) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PeopleDtoListResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PeopleDtoListResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetPeople(response: HttpResponseBase): Observable<PeopleDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PeopleDtoListResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PeopleDtoListResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    search(body: InputDto | undefined): Observable<OutputData> {
        let url_ = this.baseUrl + "/api/services/app/Categories/search";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<OutputData>><any>_observableThrow(e);
                }
            } else
                return <Observable<OutputData>><any>_observableThrow(response_);
        }));
    }

    protected processSearch(response: HttpResponseBase): Observable<OutputData> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = OutputData.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<OutputData>(<any>null);
    }
}
...
export class OutputData implements IOutputData {
    people: PeopleDto[] | undefined;
    jokes: string[] | undefined;

    constructor(data?: IOutputData) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["people"])) {
                ...
                for (let item of _data["people"])
                    this.people.push(PeopleDto.fromJS(item));
            }
    ...
    static fromJS(data: any): OutputData {
        data = typeof data === 'object' ? data : {};
        let result = new OutputData();
        result.init(data);
        return result;
    }
...
export class PeopleDto implements IPeopleDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.hair_color = _data["hair_color"];
            this.skin_color = _data["skin_color"];
            this.eye_color = _data["eye_color"];
            this.birth_year = _data["birth_year"];
...
export class PeopleDtoListResultDto implements IPeopleDtoListResultDto {
    items: PeopleDto[] | undefined;

    constructor(data?: IPeopleDtoListResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(PeopleDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PeopleDtoListResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new PeopleDtoListResultDto();
        result.init(data);
        return result;
    }
...
export interface IPeopleDtoListResultDto {
    items: PeopleDto[] | undefined;
}
